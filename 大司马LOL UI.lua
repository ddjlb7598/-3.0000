...
function Ripple(obj)
	spawn(function()
		...
		Ripple.ZIndex = 8
		Ripple.Image = "rbxassetid://120259348660392"
...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(25, 25, 25)
      ...
      DropShadow.Image = "rbxassetid://104610072426197" --背景
...
Open.Size = UDim2.new(0.6, 1, 0.6, 1)
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://113478493756976"
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://120259348660392" or "rbxassetid://120259348660392" --开关的图
end)
